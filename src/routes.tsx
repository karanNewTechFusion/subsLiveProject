...
import BidInvites from "./pages/bidInvites/BidInvites";
...
export const router = createBrowserRouter([
  {
    ...
    {
    path: "/signup",            // signup route add kiya yahan
    element: <MultiStepForm />,        // signup page component
  },
  {
    path: "/",
